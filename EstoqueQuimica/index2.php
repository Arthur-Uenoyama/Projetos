...
<div class="container">
    ...
    <a href="adicionar2.php" class="btn btn-primary mb-3">Adicionar Utensílio</a>
    ...
    <table class="table table-bordered">
        ...
        if (count($utensilios) > 0) {
            foreach ($utensilios as $utensilio) {
                ...
                echo "<td>
                    <a href='editar2.php?id=" . $utensilio['id'] . "' class='btn btn-warning btn-sm'>
                        <i class='bi bi-clipboard-check'></i> Editar
                    </a>
                    <a href='excluir2.php?id=" . $utensilio['id'] . "' class='btn btn-danger btn-sm'>
