...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bindValue(':laboratorio', $laboratorio); // Assegure-se de que o valor corresponde ao ID no banco

    // Execute a instrução e verifique se foi bem-sucedida
    if ($stmt->execute()) {
        $mensagem = "Utensílio '$nome_utensilio' adicionado com sucesso!";
    } else {
