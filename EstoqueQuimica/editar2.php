...
// Consulta para obter o utensílio
...
// Consulta para obter os laboratórios
$sqlLaboratorios = "SELECT id, Descricao FROM tblLaboratorio"; // Correção aqui: usar 'Descricao'
            ...
            <select class="form-select" id="laboratorio" name="laboratorio" required>
                ...
                <?php foreach ($laboratorios as $lab): ?>
                    <option value="<?php echo $lab['id']; ?>" <?php echo ($row['Laboratorio'] == $lab['id']) ? 'selected' : ''; ?>>
                        <?php echo htmlspecialchars($lab['Descricao']); ?> <!-- Corrigido para 'Descricao' -->
                    </option>
                <?php endforeach; ?>
            </select>
        </div>
