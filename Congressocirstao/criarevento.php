...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
    <div class="w3-container">
<h2>Criar Evento</h2><hr>
<form method="POST" action="criareventoAction.php" enctype="multipart/form-data">
  <label class="w3-label"><i class="fas fa-edit"></i> Nome do Evento</label>
    <input class="w3-input" type="text" name="txtNomeEvento" >

    <label class="w3-label"><i class="fa fa-calendar-alt"></i> Data de Inicio do Evento</label>
    <input class="w3-input" type="date" name="txtDataEvento" >

    <label class="w3-label"><i class="fa fa-calendar-alt"></i> Data do Fim do Evento</label>
    <input class="w3-input" type="date" name="txtDataFinalEvento" >
  ...
  <label class="w3-label"><i class="fas fa-building"></i> Nome do Hotel</label>
    <input class="w3-input" type="text" name="txtNomeHotel" >
