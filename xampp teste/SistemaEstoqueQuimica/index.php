...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
            // SQL para buscar os materiais no banco de dados
            ...
            // Buscar todos os materiais e armazenar em um array
            $materiais = $stmt->fetchAll(PDO::FETCH_ASSOC);

            // Verificar se há materiais
            if (count($materiais) > 0) {
                // Loop para exibir os materiais
                ...
                // Exibe uma mensagem se não houver materiais
